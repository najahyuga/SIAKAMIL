            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="semesters-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="/semesters/create" class="active">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/semesters">Dashboard</a>Semesters Data</li>
                        <li class="breadcrumb-item active">InsertSemesters Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section">
                <div class="row">
                    <div class="card col-lg">
                        <div class="card-body">
                            <h5 class="card-title">Forms Add Semesters Data</h5>
                                ...
                                <div class="form-group mb-3">
                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">Semester
                                            <span class="badge bg-danger"><i class="bi bi-exclamation-octagon me-1"></i>Contoh: Semester Ganjil/Semester Genap</span><br>
                                        </label>
                                        <select class="form-select @error('name') is-invalid @enderror" name="name" aria-label="Default select example">
                                            <option selected>Pilih Semester</option>
                                            <option value="Semester 1 Ganjil" {{ (old('name')=='Semester 1 Ganjil') ? 'selected' : '' }}>Semester 1 Ganjil</option>
                                            <option value="Semester 2 Genap" {{ (old('name')=='Semester 2 Genap') ? 'selected' : '' }}>Semester 2 Genap</option>
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('startDate') is-invalid @enderror" name="startDate" value="{{ old('startDate') }}" placeholder="Masukkan Semester Mulai!">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('endDate') is-invalid @enderror" name="endDate" value="{{ old('endDate') }}" placeholder="Masukkan Semester Selesai!">
                                    ...
                                    <select class="form-select @error('education_levels_id') is-invalid @enderror" name="education_levels_id" aria-label="Pilih Jenjang Pendidikan Yang Akan Di Mulai">
                                        <option selected>Pilih Jenjang Pendidikan Yang Akan Di Mulai</option>

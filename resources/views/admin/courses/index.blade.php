...
<html lang="en">
    <head>
        ...
        <title>Management Courses - SIAKAMIL</title>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Courses Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                                        ...
                                        @forelse ($courses as $row)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form method="POST">
                                                        <a href="{{ route('courses.show', $row->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                                        <a href="{{ route('courses.edit', $row->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                        @csrf
                                                    </form>
                                                </td>
                                            </tr>

...
<html lang="en">
    <head>
        ...
        <title>Management Jenjang Pendidikan - SIAKAMIL</title>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="educationLevels-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="/admin/educationLevels" class="active">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/educationLevels">Education Levels Data</a></li>
                        <li class="breadcrumb-item active">Show Education Levels Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                            ...
                            <div class="card-body pt-3">
                                ...
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Jenis Jenjang Pendidikan</div>
                                            <div class="col-lg-9 col-md-8">{{ $educationLevel->name }}</div>
                                        </div>
                                    </div>{{-- End List --}}

                                    <!-- Start Profile Edit Form -->
                                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                        <form action="{{ route('admin.educationLevels.update', $educationLevel->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <select class="form-select @error('name') is-invalid @enderror" name="name" aria-label="Default select example">
                                                    ...
                                                    <option value="Paket A Setara SD" {{ ($educationLevel->name=='Paket A Setara SD') ? 'selected' : '' }}>Paket A Setara SD</option>
                                                    <option value="Paket B Setara SMP" {{ ($educationLevel->name=='Paket B Setara SMP') ? 'selected' : '' }}>Paket B Setara SMP</option>
                                                    <option value="Paket C Setara SMA" {{ ($educationLevel->name=='Paket C Setara SMA') ? 'selected' : '' }}>Paket C Setara SMA</option>
                                                </select>

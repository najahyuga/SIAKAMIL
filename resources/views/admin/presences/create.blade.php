...
<head>
    ...
    <title>Management Presensi - SIAKAMIL</title>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="educationLevels-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="/admin/presences/create" class="active">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/presences">Presences Data</a></li>
                    <li class="breadcrumb-item active">Insert Presences Data</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="card col-lg">
                    <div class="card-body">
                        <h5 class="card-title">Forms Add Presences Data</h5>

                        <!-- Custom Styled Validation with Tooltips novalidate -->
                        <form action="{{ route('admin.presences.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                <label for="courses_id">Kelas</label>
                                <select id="courses_id" class="form-control @error('courses_id') is-invalid @enderror" name="courses_id" required>
            ...
            if (courseId) {
                ...
                fetch(classroomsUrl)
                    ...
                    .then(classroomsData => {
                        ...
                        // Update UI dengan data classrooms
                        const classroomsSelect = document.getElementById('classrooms_id');
                        classroomsSelect.innerHTML = '<option selected disabled>Pilih Kelas</option>';
                        classroomsData.forEach(classroom => {
                            const option = document.createElement('option');
                            option.value = classroom.id;
                            option.textContent = `${classroom.name} / ${classroom.semester.name}`;

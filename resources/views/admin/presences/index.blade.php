            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Presences Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                                        ...
                                        <tbody>
                                            @forelse ($presences as $presence)
                                                <tr>
                                                    ...
                                                    <td>{{ $presence->deadline }}</td>
                                                    <td>{{ $presence->course->classrooms->name }} / {{ $presence->course->classrooms->semesters->name }}</td>
                                                    <td><a href="{{ route('admin.presences.show', $presence->id) }}" class="btn btn-info">Lihat</a></td>
                                                </tr>
                                            @empty
                                                <tr>

            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="educationLevels-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="/admin/presences" class="active">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.presences.show', $presence->id) }}">Presences Data Details</a></li>
                        <li class="breadcrumb-item active">Presences Data Submit</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->

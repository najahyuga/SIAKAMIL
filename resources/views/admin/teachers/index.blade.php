            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Teachers Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                                ...
                                <tbody>
                                    @forelse ($teachers as $index => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST">
                                                    <a href="{{ route('teacher.show', $data->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                                    <a href="{{ route('teacher.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                    @csrf
                                                </form>
                                            </td>
                                        </tr>

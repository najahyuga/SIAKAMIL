    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link collapse" data-bs-target="#teachers-nav" data-bs-toggle="collapse" href="#">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/teacher">Teachers Data</a></li>
                        <li class="breadcrumb-item active">Edit Teacher Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('teacher.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('dateOfBirth') is-invalid @enderror" name="dateOfBirth" value="{{ old('dateOfBirth', $teacher->dateOfBirth) }}" placeholder="Masukkan Tanggal Lahir Anda!">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{ asset('/storage/images/'.$teacher->image) }}" class="rounded mb-2" style="width: 10%" alt="image">
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">Status Keaktifan
                                            <span class="badge bg-success"><i class="bi bi-exclamation-octagon me-1"></i>Default Active</span><br>
                                        </label>
                                        <select class="form-select @error('status') is-invalid @enderror" name="status" aria-label="Default select example">
                                            ...
                                            <option value="non-active" {{ ($teacher->status=='non-active') ? 'selected' : '' }}>Non-Active</option>
                                        </select>
                                        <!-- error message untuk jenis kelamin -->
                                        @error('gender')
                                            <div class="alert alert-danger mt-2">
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">Role Level
                                            <span class="badge bg-danger"><i class="bi bi-exclamation-octagon me-1"></i>Default Calon Siswa</span><br>
                                        </label>

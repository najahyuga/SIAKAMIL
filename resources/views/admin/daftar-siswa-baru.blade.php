...
<html lang="en">
    <head>
        ...
        <title>Mengelola PSB - SIAKAMIL</title>
    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <!-- Start Mengelola PSB Nav -->
                <li class="nav-item">
                    <a class="nav-link " href="/admin/users">
                        <i class="bi bi-clipboard-data"></i>
                        <span>Daftar Siswa Baru</span>
                    </a>
                </li><!-- End Mengelola PSB Nav -->
            ...
            <section class="section dashboard">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Data Daftar Tugas</h5>
                                    ...
                                    <tbody>
                                        @forelse ($calonSiswa as $siswa)
                                            <tr>
                                                ...
                                                <td>{{ $siswa->address }}</td>
                                                <td>
                                                    <form class="status-form" action="{{ route('admin.update-status') }}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="form_siswa_id" value="{{ $siswa->id }}">
                                                        <select name="status" class="form-control">
                                                            <option value="data-terkirim" {{ $siswa->status == 'data-terkirim' ? 'selected' : '' }}>Data Terkirim</option>
                                                            <option value="diterima" {{ $siswa->status == 'diterima' ? 'selected' : '' }}>Diterima</option>
                                                            <option value="data-checking" {{ $siswa->status == 'data-checking' ? 'selected' : '' }}>Data Checking</option>
                                                            <option value="daftar-ulang" {{ $siswa->status == 'daftar-ulang' ? 'selected' : '' }}>Daftar Ulang</option>
                                                        </select>
                                                </td>
                                                        <td><button type="submit" class="btn btn-primary mt-2 update-status-button">Update Status</button></td>
                                                    </form>
                                            </tr>
                                        @empty
                                            <div class="alert alert-danger">
                                                Data Siswa Baru belum Tersedia.
                                            </div>
                                        @endforelse
                                    </tbody>
                                </table>

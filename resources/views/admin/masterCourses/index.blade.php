            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Master Courses Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                                ...
                                <table class="table datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Master Kategori Mata Pelajaran</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse ($masterCourses as $row)
                                            <tr>
                                                <td>{{ $loop->iteration}}</td>
                                                <td>{{ $row->name }}</td>
                                                <td>
                                                    {{ $row->master_category_course->name ?? 'N/A' }}
                                                </td>
                                                <td class="text-center">
                                                    <form method="POST">
                                                        <a href="{{ route('admin.masterCourses.show', $row->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                                        <a href="{{ route('admin.masterCourses.edit', $row->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                        @csrf
                                                    </form>
                                                </td>
                                            </tr>
                                        @empty
                                            <div class="alert alert-danger">
                                                Data Master Pelajaran belum Tersedia.
                                            </div>
                                        @endforelse
                                    </tbody>
                                </table>

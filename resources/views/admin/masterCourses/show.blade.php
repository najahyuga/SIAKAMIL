            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="masterCourses-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="/admin/masterCourses" class="active">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Show Master Course Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                        ...
                        <div class="card">
                            <div class="card-body pt-3">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bordered">
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Edit Master Courses</button>
                                    </li>
                                </ul>
                                <div class="tab-content pt-2">
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8">{{ $masterCourses->name }}</div>
                                        </div>

                                        <h6 class="card-title">Details</h6>
                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Kategori Pelajaran</div>
                                            <div class="col-lg-9 col-md-8">{{ $masterCourses->master_category_course->name }}</div>
                                        </div>
                                    </div>
                                    {{-- End List --}}
                                    ...
                                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                        <form action="{{ route('admin.masterCourses.update', $masterCourses->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')

                                            <div class="form-group mb-3">
                                                <label for="fullName" class="font-weight-bold">Nama Pelajaran</label>
                                                <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $masterCourses->name) }}" placeholder="Masukkan Nama Pelajaran!">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select @error('master_category_courses_id') is-invalid @enderror" name="master_category_courses_id" aria-label="Pilih Master Kategori Pelajaran">
                                                    <option value="{{ $masterCourses->master_category_course->id }}">{{ $masterCourses->master_category_course->name }}</option>
                                                    @foreach ($master_category_course as $data)

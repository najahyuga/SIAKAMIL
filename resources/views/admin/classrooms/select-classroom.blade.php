...
<html lang="en">
    <head>
        ...
        <title>Management Kenaikan Kelas - SIAKAMIL</title>
    ...
    <body>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="Classrooms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="/admin/select-classroom" class="active">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/classrooms">Classrooms Data</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body pt-3">
                                <h1>Pilih Kelas dan Update Siswa</h1>
                                ...
                                <form action="{{ route('admin.students.updateHistory') }}" method="POST">
                                    @csrf
                                    {{-- <div class="form-group">
                                        <label for="classroom_id">Pilih Kelas:</label>
                                        <select name="classroom_id" id="classroom_id" class="form-control">
                                            <option value="">Pilih Kelas Untuk Update Kenaikan Kelas</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="students[]" id="students" class="form-control" multiple>
                                            <!-- Students list will be populated dynamically based on selected classroom -->
                                        </select>
                                    </div>

                                    <div class="form-group">
                                        <label for="new_classroom_id">New Classroom:</label>
                                        <select name="new_classroom_id" id="new_classroom_id" class="form-control">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="students">Pilih Siswa Untuk Kenaikan Kelas:</label><br>
                                        <button type="button" id="check_all" class="btn btn-secondary btn-sm mb-2">Pilih Semua Siswa</button>
                                        <table class="table table-bordered">
                                            ...
                                            <tbody id="students">
                                                <!-- Daftar siswa akan diisi secara dinamis berdasarkan kelas yang dipilih -->
                                            </tbody>
                                        </table>
                                    </div>
        ...
        {{-- <script>
            // Handle change event on classroom_id dropdown
            document.getElementById('classroom_id').addEventListener('change', function() {
                ...
                // Fetch students for selected classroom via AJAX
                fetch('/admin/classrooms/' + classroomId + '/students')
        ...
        <script>
            // Tangani perubahan pada dropdown classroom_id
            document.getElementById('classroom_id').addEventListener('change', function() {
                var classroomId = this.value;
                ...
                // Ambil siswa untuk kelas yang dipilih melalui AJAX
                fetch('/admin/classrooms/' + classroomId + '/students')
                    .then(response => response.json())
                    .then(data => {
                        data.forEach(student => {
            ...
            document.getElementById('check_all').addEventListener('click', function() {
                var checkboxes = document.querySelectorAll('#students input[type="checkbox"]');

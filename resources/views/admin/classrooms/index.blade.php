            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Classrooms Data</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            ...
            <section class="section dashboard">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Data Classrooms</h5>
                                <table class="table datatable">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama Kelas</th>
                                            <th>Semester Yang Dipilih</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse ($classrooms as $row)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form method="POST">
                                                        <a href="{{ route('classrooms.show', $row->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                                        @csrf
                                                    </form>
                                                </td>
                                            </tr>

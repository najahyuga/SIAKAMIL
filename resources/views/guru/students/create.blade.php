        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="students-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="/guru/students/create" class="active">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('guru.students.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @foreach ($roles as $role)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="level[]" value="{{ $role->id }}" id="role{{ $role->id }}" @if ($roles->contains($role->id))  @endif>
                                        ...
                                        @foreach ($master_categories as $master_category)
                                            <div class="col-md-6">
                                                ...
                                                @foreach ($master_category->masterCourses as $master_course)
                                                    <div class="form-check">
                                                        <input class="form-check-input course-checkbox" type="checkbox" value="{{ $master_course->id }}" name="master_courses_id[]" id="master_course_{{ $master_course->id }}" {{ in_array($master_course->id, old('master_courses_id', [])) ? 'checked' : '' }} disabled>

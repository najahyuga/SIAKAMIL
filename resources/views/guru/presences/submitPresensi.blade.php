        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('guru.presences.show', $presence->id) }}">Presences Data Details</a></li>
            ...
            <div class="row">
                <div class="card col-lg">
                    <div class="card-body">
                        ...
                        <form action="{{ route('guru.presences.submit', $presence->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
